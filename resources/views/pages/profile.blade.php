    ...
    <div class="my-5 d-flex flex-column align-items-center">
        <div class="my-5 d-flex flex-column align-items-center">
            ...
            <div class="d-flex align-items-center gap-2">
                <p class="fs-2 fw-semibold text-center">{{ $user->name }}</p>
                <svg data-bs-toggle="modal" data-bs-target="#editProfileModal" xmlns="http://www.w3.org/2000/svg"
                    width="16" height="16" fill="currentColor" class="bibi-pencil-square" viewBox="0 0 16 16"
    ...
    <div class="d-flex justify-content-center">
        <div class="w-75 row justify-content-center">
            @foreach ($photos as $photo)
                <a href="{{ route('photo.index', $photo->id) }}" class="m-1 col-4 w-25 ratio ratio-1x1 mb-3">
                    <div class="image"
