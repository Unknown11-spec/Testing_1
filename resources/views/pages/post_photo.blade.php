...
<div class="d-flex justify-content-center">
    <div class="w-25 my-5 rounded p-4 shadow-lg">
        ...
        <form action="{{route('photo.postProcess')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <input class="form-control" type="file" id="photo" accept="image/jpg, image/jpeg, image/png" name="photo" aria-label="photo upload">
                @error('photo')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="judul_foto" id="judul_foto" placeholder="Judul Foto...">
                @error('judul_foto')
                    <small class="text-danger">{{$message}}</small>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi_foto" class="form-control" id="" cols="30" rows="10"></textarea>
