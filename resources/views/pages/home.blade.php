...
<div class="row justify-content-center align-items-start">
    ...
    <div class="col-10 col-md-3 mx-1 my-3 p-1 rounded shadow-lg">
        <div class="d-flex justify-content-between align-items-center">
            <a href="{{ route('profile.people', $photo->user->id) }}" class="ms-3 mt-3 mb-4 d-flex justify-content-start align-items-center mb-2 text-decoration-none">
                ...
                <span class="ms-2 fs-5 text-dark">{{ $photo->user->name }}</span>
            </a>
        ...
        <a href="{{ route('photo.index', $photo->id) }}" class="text-decoration-none">
            <img src="{{ asset('storage/' . $photo->lokasi_file) }}" alt="{{ $photo->judul_foto }}" class="img-fluid mx-auto d-block" >
